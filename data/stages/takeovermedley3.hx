...
function postUpdate(){
    ...
    camZooming = true;
    strumLines.members[2].characters[0].y = bgsepie.y - 0;

    strumLines.members[2].characters[0].x = bgsepie.x + 10;
    ...
    strumLines.members[3].characters[0].x = box.x - 30;
    strumLines.members[3].characters[0].y = 250 - 280;
    strumLines.members[3].characters[0].scale.set(0.98,0.98);
    

    strumLines.members[4].characters[0].x = box.x + 100;
    strumLines.members[4].characters[0].y = -30;

    strumLines.members[5].characters[0].x = box.x + 150;
    strumLines.members[5].characters[0].y = 180;

    strumLines.members[5].characters[1].x = box.x + 100;
    strumLines.members[5].characters[1].y = 20;
    
    strumLines.members[6].characters[0].x = box.x + 100;
    strumLines.members[6].characters[0].y = -20;

    strumLines.members[7].characters[0].x = box.x + 50;
    strumLines.members[7].characters[0].y = box.y - 10;
    strumLines.members[1].characters[0].y = -70;
...
function postCreate(){
    ...
    remove(iconP2);
    iconP2 = new HealthIcon("senpai", false);
...
function stepHit(curStep){
    ...
    switch(curStep){
        ...
        case 460:
            ...
            remove(iconP2);
            iconP2 = new HealthIcon("spookysm", false);
            iconP2.cameras = [camHUD];
            iconP2.y = healthBar.y - 75;
            iconP2.x = iconP2;
            insert(members.indexOf(iconP1) + 1, iconP2);
        ...
        case 844:
            ...
            remove(iconP2);
            iconP2 = new HealthIcon("mom", false);
            iconP2.cameras = [camHUD];
            iconP2.y = healthBar.y - 75;
            iconP2.x = iconP2;
            insert(members.indexOf(iconP1) + 1, iconP2);
            ...
            FlxTween.tween(bgmonka, {"scale.y": 1.3}, Conductor.crochet / 10000);
            FlxTween.tween(bgabbie, {"scale.x": 1.5, "scale.y": 1.6}, Conductor.crochet / 10000);
            FlxTween.tween(box, {"scale.x": 1.5, "scale.y": 1.6}, Conductor.crochet / 10000);
        ...
        case 1228:
            ...
            bgabbie.alpha = 0;
            remove(iconP2);
            FlxTween.tween(box, {"scale.y": 1.5, "scale.x": 1.3}, Conductor.crochet / 10000);
            bgmonka.alpha = 0;
            iconP2 = new HealthIcon("cass", false);
            iconP2.cameras = [camHUD];
            iconP2.y = healthBar.y - 75;
            iconP2.x = iconP2;
            insert(members.indexOf(iconP1) + 1, iconP2);
